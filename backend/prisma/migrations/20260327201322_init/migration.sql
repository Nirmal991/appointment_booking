...
-- CreateIndex
CREATE INDEX "BookingLock_serviceId_startTime_endTime_idx" ON "BookingLock"("serviceId", "startTime", "endTime");
...
-- AddForeignKey
ALTER TABLE "BookingLock" ADD CONSTRAINT "BookingLock_serviceId_fkey" FOREIGN KEY ("serviceId") REFERENCES "Service"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
